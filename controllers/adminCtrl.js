...
const changeAccountStatusController = async(req,res) => {
  ...
  try {
    ...
    const fitnessConsultant = await fitnessConsultantModel.findByIdAndUpdate(fitnessConsultantId,{status});
...
module.exports = { getAllFitnessConsultantController, getAllUsersController, changeAccountStatusController, deleteFitnessConsultantController };
